...
def test_baseline_cli_create_show_list_and_diff(
    ...
    assert created["schema"] == "weft.plainweave.baseline.v1"
    ...
    assert listed["schema"] == "weft.plainweave.baseline_list.v1"
    ...
    assert diff["schema"] == "weft.plainweave.baseline_diff.v1"
