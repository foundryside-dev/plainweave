...
@pytest.fixture
def client(project_root):  # type: ignore[no-untyped-def]
...
def test_plainweave_error_renders_error_partial(project_root) -> None:  # type: ignore[no-untyped-def]
...
def test_csrf_blocks_mutation_without_token(project_root) -> None:  # type: ignore[no-untyped-def]
...
def test_csrf_passes_mutation_with_valid_token(project_root) -> None:  # type: ignore[no-untyped-def]
